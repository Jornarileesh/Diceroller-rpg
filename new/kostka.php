...
<script type="text/javascript">
  ...
  (function() {
	...
	<body>
        <header>            
            <h1>Generator rzutu kośćmi</h1>
            <<p><a href="http://www.alea.cba.pl">Alea.cba.pl</a></p>
            <nav>
                <ul>
                    <li><a href="/" onClick="javascript:_gaq.push(['_trackPageview', 'powrot_stara_wersja']);">Generator - stara wersja</a></li>
                </ul>
            </nav>
        </header>
        <section id="spacer">   
...
?>
        ...
        <footer>
            <section id="copyright">
                ...
                <div class="wrapper">
                    &copy; Copyright 2014 by <a href="http://www.alea.cba.pl">Alea.cba.pl</a>
                </div>
            </section>
